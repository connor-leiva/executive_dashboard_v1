...
export default {
  ...
  billing: {
    ...
    monthly: [
      { month: "Jan", net: 0, mtd: false, projected: false },
      { month: "Feb", net: 0, mtd: false, projected: false },
      { month: "Mar", net: 0, mtd: false, projected: false },
      { month: "Apr", net: 19500, mtd: false, projected: false },
      { month: "May", net: 84500, mtd: false, projected: false },
      { month: "Jun", net: 28600, mtd: false, projected: false },
      { month: "Jul", net: 9400, mtd: true, projected: false },
      { month: "Aug", net: 20200, mtd: false, projected: true },
      { month: "Sep", net: 20200, mtd: false, projected: true },
      { month: "Oct", net: 20200, mtd: false, projected: true },
      { month: "Nov", net: 20200, mtd: false, projected: true },
      { month: "Dec", net: 20200, mtd: false, projected: true },
    ],

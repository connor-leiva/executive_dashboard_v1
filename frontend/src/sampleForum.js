...
export default {
  ...
  billing: {
    ...
    monthly: [
      { month: "Jan", ym: "2026-01", net: 0, mtd: false, projected: false },
      { month: "Feb", ym: "2026-02", net: 0, mtd: false, projected: false },
      { month: "Mar", ym: "2026-03", net: 0, mtd: false, projected: false },
      { month: "Apr", ym: "2026-04", net: 19500, mtd: false, projected: false },
      { month: "May", ym: "2026-05", net: 84500, mtd: false, projected: false },
      { month: "Jun", ym: "2026-06", net: 28600, mtd: false, projected: false },
      { month: "Jul", ym: "2026-07", net: 9400, mtd: true, projected: false },
      { month: "Aug", ym: "2026-08", net: 20200, mtd: false, projected: true },
      { month: "Sep", ym: "2026-09", net: 20200, mtd: false, projected: true },
      { month: "Oct", ym: "2026-10", net: 20200, mtd: false, projected: true },
      { month: "Nov", ym: "2026-11", net: 20200, mtd: false, projected: true },
      { month: "Dec", ym: "2026-12", net: 20200, mtd: false, projected: true },
    ],

...
export default {
  ...
  roster_detail: {
    ...
    rows: [
      ...
      { id: "r3", name: "Alicia Romero", seg: "F", kind: "primary", member_type: "Primary Member", status: "Active", payment: "pif", amount: 30000, enrolled: "2024-09-01", renews: "2026-09-01", brokerage: "Keller Williams", stripe_account: "Legacy SB Account", event: false, source_url: "https://app.gohighlevel.com/" },
      { id: "r4", name: "Sam Kessler", seg: "F", kind: "primary", member_type: "Primary Member", status: "Active", payment: "quarterly", amount: 30000, enrolled: "2025-01-14", renews: "2026-10-14", brokerage: "Real Broker", stripe_account: "Forum Sub-Account", event: true, source_url: "https://app.gohighlevel.com/" },
      { id: "r5", name: "Priya Nair", seg: "F", kind: "add_on", member_type: "Add-On Member", status: "Active", payment: "pif", amount: 0, enrolled: "2025-01-14", renews: "2026-10-14", brokerage: "Real Broker", stripe_account: "Forum Sub-Account", event: false, source_url: "https://app.gohighlevel.com/" },
      { id: "r6", name: "Devon Walsh", seg: "F", kind: "primary", member_type: "Primary Member", status: "Active", payment: "monthly", amount: 27000, enrolled: "2024-11-30", renews: "2026-11-30", brokerage: null, stripe_account: "Legacy SB Account", event: true, source_url: "https://app.gohighlevel.com/" },
      { id: "r7", name: "Hannah Brooks", seg: "F", kind: "primary", member_type: "Primary Member", status: "Active", payment: "pif", amount: 27000, enrolled: "2024-03-18", renews: "2026-07-18", brokerage: "The Agency", stripe_account: "Legacy SB Account", event: false, source_url: "https://app.gohighlevel.com/" },
      { id: "r8", name: "Carlos Mendez", seg: "F", kind: "primary", member_type: "Primary Member", status: "Active", payment: "pif", amount: 30000, enrolled: "2023-12-05", renews: "2026-12-05", brokerage: "eXp Realty", stripe_account: "Legacy SB Account", event: true, source_url: "https://app.gohighlevel.com/" },
      { id: "r9", name: "Renee Fowler", seg: "F", kind: "primary", member_type: "Primary Member", status: "Active", payment: "installments", amount: 30000, enrolled: "2025-02-27", renews: "2026-09-27", brokerage: "RE/MAX", stripe_account: "Forum Sub-Account", event: false, source_url: "https://app.gohighlevel.com/" },
      { id: "r10", name: "Tobias Frey", seg: "F", kind: "primary", member_type: "Primary Member", status: "Active", payment: "pif", amount: 30000, enrolled: "2024-06-11", renews: "2026-08-11", brokerage: "Keller Williams", stripe_account: "Legacy SB Account", event: true, source_url: "https://app.gohighlevel.com/" },
      { id: "r11", name: "Dana Whitfield", seg: "IC", kind: "primary", member_type: "Primary Member", status: "Active", payment: "monthly", amount: 6000, enrolled: "2024-08-19", renews: "2026-08-19", brokerage: "Compass", stripe_account: "Forum Sub-Account", event: true, source_url: "https://app.gohighlevel.com/" },
      { id: "r12", name: "Chris Boone", seg: "IC", kind: "primary", member_type: "Primary Member", status: "Active", payment: "pif", amount: 6000, enrolled: "2024-09-09", renews: "2026-09-09", brokerage: null, stripe_account: "Legacy SB Account", event: false, source_url: "https://app.gohighlevel.com/" },
      { id: "r13", name: "Maya Iqbal", seg: "IC", kind: "primary", member_type: "Primary Member", status: "Active", payment: "pif", amount: 6000, enrolled: "2025-03-03", renews: "2026-10-03", brokerage: "eXp Realty", stripe_account: "Forum Sub-Account", event: true, source_url: "https://app.gohighlevel.com/" },
      { id: "r14", name: "Grant Ellison", seg: "IC", kind: "add_on", member_type: "Add-On Member", status: "Active", payment: "pif", amount: 0, enrolled: "2025-03-03", renews: "2026-10-03", brokerage: "eXp Realty", stripe_account: "Forum Sub-Account", event: false, source_url: "https://app.gohighlevel.com/" },
      { id: "r15", name: "Olivia Park", seg: "IC", kind: "primary", member_type: "Primary Member", status: "Active", payment: "monthly", amount: 6000, enrolled: "2024-04-25", renews: "2026-07-25", brokerage: "Real Broker", stripe_account: "Legacy SB Account", event: true, source_url: "https://app.gohighlevel.com/" },
      { id: "r16", name: "Nathan Cole", seg: "IC", kind: "primary", member_type: "Primary Member", status: "Active", payment: "installments", amount: 6000, enrolled: "2025-01-08", renews: "2026-11-08", brokerage: "The Agency", stripe_account: "Forum Sub-Account", event: false, source_url: "https://app.gohighlevel.com/" },

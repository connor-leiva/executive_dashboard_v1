...
export const deleteWtdList = (listId) => consoleSend("DELETE", `/wtd-lists/${listId}`);
export const getWtdPlaybook = () => consoleGet("/wtd/playbook");
export const patchWtdPlaybook = (body) => consoleSend("PATCH", "/wtd/playbook", body);
export const getWtdScripts = () => consoleGet("/wtd/scripts");
export const createWtdScript = (body) => consoleSend("POST", "/wtd/scripts", body);
export const patchWtdScript = (scriptId, body) => consoleSend("PATCH", `/wtd/scripts/${scriptId}`, body);
export const deleteWtdScript = (scriptId) => consoleSend("DELETE", `/wtd/scripts/${scriptId}`);
export const putWtdScriptOrder = (body) => consoleSend("PUT", "/wtd/scripts/order", body);
export const checkWtdLists = () => consoleGet("/wtd/lists/check");

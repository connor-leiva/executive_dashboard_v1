...
.adsx {
  ...
  background:${C.page}; min-height:100%; font-family:var(--font-text); color:${C.ink};
  text-wrap:pretty;
}
...
.adsx .ptitle { font-family:var(--font-display); font-size:var(--a-title); font-weight:700; letter-spacing:-.015em; }
...
.adsx .per { font-family:var(--font-text); font-size:var(--a-small); font-weight:600; color:${C.slate};
...
.adsx .hgrid { display:grid; grid-template-columns:minmax(0,1fr) minmax(290px,380px); gap:30px;
  align-items:stretch; }
.adsx .eyebrow { font-family:var(--font-display); font-size:var(--a-cap); font-weight:700; letter-spacing:.13em;
  text-transform:uppercase; color:${C.sprout}; }
.adsx .heronum { font-family:var(--font-display); font-size:var(--a-hero); font-weight:700; color:${C.onDark};
...
.adsx .hroas b { font-family:var(--font-display); font-size:var(--a-xl); font-weight:700; color:${C.sprout};
...
.adsx .hflab { display:block; font-family:var(--font-display); font-size:var(--a-micro);
...
.adsx .lhead { padding:8px 14px; border-bottom:1px solid rgba(248,245,242,.14);
  font-family:var(--font-display); font-size:var(--a-micro); font-weight:700; letter-spacing:.14em;
...
.adsx .llab { display:inline-flex; align-items:center; gap:7px; font-family:var(--font-display);
...
.adsx .lnum { display:inline-flex; align-items:baseline; gap:8px; justify-self:end;
  font-family:var(--font-display); font-size:var(--a-fig); font-weight:700; color:${C.onDarkMute};
...
.adsx .rlink b { font-family:var(--font-display); font-size:var(--a-micro); font-weight:700;
...
.adsx .railsum b { font-family:var(--font-display); color:${C.ink}; font-weight:700; }
...
.adsx .sn { font-family:var(--font-display); font-size:var(--a-cap); font-weight:700; letter-spacing:.14em;
  color:${C.teal}; font-variant-numeric:tabular-nums; }
.adsx .st { margin:0; font-family:var(--font-display); font-size:var(--a-title); font-weight:700;
...
.adsx .klead { display:inline-flex; align-items:center; gap:9px; font-family:var(--font-display);
...
.adsx .rn { font-family:var(--font-display); font-size:var(--a-fig); font-weight:700; color:${C.ink};
...
.adsx .rcost { font-family:var(--font-display); font-size:var(--a-small); font-weight:600; color:${C.muted};
  text-align:right; font-variant-numeric:tabular-nums; }
...
.adsx .fbody { display:block; font-size:var(--a-small); color:${C.flagText}; line-height:1.6;
  max-width:76ch; }
.adsx .fbody b { display:inline-block; font-family:var(--font-display); font-size:var(--a-micro);
...
.adsx .zmeta > span:first-child { font-family:var(--font-display); font-size:var(--a-cap); font-weight:700;
...
.adsx .zcross { display:flex; align-items:baseline; justify-content:space-between; gap:14px;
  ...
  margin:18px 0 8px; }
.adsx .zbig { font-family:var(--font-display); font-size:var(--a-cap); font-weight:700;
...
.adsx .skey b { font-family:var(--font-display); color:${C.ink}; font-variant-numeric:tabular-nums; }
...
.adsx .mgrid b { font-family:var(--font-display); font-size:var(--a-fig); font-weight:700; color:${C.ink};
  font-variant-numeric:tabular-nums; }
...
.adsx .fhead { font-family:var(--font-display); font-size:var(--a-fig); font-weight:700;
...
.adsx .klab { font-family:var(--font-display); font-size:var(--a-micro); font-weight:700; letter-spacing:.1em;
  text-transform:uppercase; color:${C.slate}; }
.adsx .kval { display:flex; align-items:baseline; gap:8px; flex-wrap:wrap;
  font-family:var(--font-display); font-size:var(--a-title); font-weight:700; color:${C.ink};
...
.adsx .gcount { font-family:var(--font-display); font-size:var(--a-cap); font-weight:700; color:${C.teal};
  background:${C.mist}; border-radius:20px; padding:2px 9px; font-variant-numeric:tabular-nums; }
.adsx .gname { font-family:var(--font-display); font-size:var(--a-fig); font-weight:600; color:${C.ink}; }
...
.adsx .gstat b { font-family:var(--font-display); font-size:var(--a-fig); font-weight:700; color:${C.ink};
  font-variant-numeric:tabular-nums; }
...
.adsx .grow { display:grid; grid-template-columns:1fr 84px 62px 92px 14px; gap:10px; align-items:center;
  ...
  padding:9px 6px; text-align:left; font-family:var(--font-text); font-size:var(--a-body); }
...
.adsx .gnum { text-align:right; font-family:var(--font-display); font-weight:600; color:${C.ink};
  font-variant-numeric:tabular-nums; }
...
.adsx .pill { font-family:var(--font-text); font-size:var(--a-small); font-weight:600; color:${C.slate};
...
.adsx .filt { display:inline-flex; align-items:center; gap:8px; margin-left:10px; background:${C.mist};
  border-radius:20px; padding:3px 11px; font-family:var(--font-text); font-size:var(--a-small);
...
.adsx .adrank { font-family:var(--font-display); font-size:var(--a-micro); font-weight:700; color:${C.slate};
...
.adsx .adhead { font-family:var(--font-display); font-size:var(--a-body); font-weight:600; color:${C.ink};
  line-height:1.4; margin-top:2px; display:-webkit-box; -webkit-line-clamp:3;
  -webkit-box-orient:vertical; overflow:hidden; }
.adsx .adhead.none { font-family:var(--font-text); font-weight:500; color:${C.muted}; font-style:italic; }
...
.adsx .m b { font-family:var(--font-display); font-size:var(--a-body); font-weight:700; color:${C.ink};
  font-variant-numeric:tabular-nums; }
...
.adsx .bval { text-align:right; font-family:var(--font-display); font-size:var(--a-fig); font-weight:700;
  font-variant-numeric:tabular-nums; }
...
.adsx table { width:100%; border-collapse:collapse; font-family:var(--font-text); font-size:var(--a-body); }
.adsx th { text-align:right; padding:9px; font-family:var(--font-display); font-size:var(--a-micro); font-weight:700;
...
.adsx td { padding:11px 9px; border-top:1px solid ${C.parchment}; text-align:right;
  font-family:var(--font-display); font-size:var(--a-body); font-weight:600; color:${C.ink};
  font-variant-numeric:tabular-nums; white-space:nowrap; }
.adsx td.cn { text-align:left; font-family:var(--font-text); font-weight:500; color:${C.body};
...
@media (max-width:780px){
  ...
  .adsx td::before { content:attr(data-l); font-family:var(--font-text); font-size:var(--a-small);
...
.adsx .crow b { font-family:var(--font-display); font-size:var(--a-fig); font-weight:700; text-align:right;
  font-variant-numeric:tabular-nums; }
...
.adsx .netstrip { display:flex; justify-content:space-between; align-items:baseline; gap:12px; flex-wrap:wrap;
  ...
  color:${C.body}; }
.adsx .netstrip b { font-family:var(--font-display); font-size:var(--a-fig); color:${C.ink};
  font-variant-numeric:tabular-nums; }
...
.adsx .rec b { font-family:var(--font-display); font-size:var(--a-fig); font-weight:700; color:${C.ink};
  font-variant-numeric:tabular-nums; }
...
.adsx .tlab { font-family:var(--font-display); font-size:var(--a-cap); font-weight:700; letter-spacing:.09em;
